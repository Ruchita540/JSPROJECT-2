...
function AddNewTask(){
    ...
    deleteButtonInsideTask.innerText='delete';
    plusButtonInsideTask.innerHTML='Add';
...
//  related to div that is added
    ...
    deleteButtonInsideTask.style.backgroundColor='pink';
    deleteButtonInsideTask.style.color='black';
    ...
    plusButtonInsideTask.style.color='black';
